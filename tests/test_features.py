...
from fixtures.synthetic import EXPECTED_DOUBLE_SUPPORT_PCT, synthetic_walk

STATIC_CAMERA = CameraMotion(net_px=1.0, path_px=4.0, determinate=True, n_samples=20)


def build_extraction(cfg, *, calibrate=False, **kwargs):
    """Assemble a stage-1 Extraction from synthetic landmarks, without video."""
    ...
    return Extraction(
        ...
        series=series,
        segments=segments,
        camera_motion=STATIC_CAMERA,
        speed=feasibility.assess_speed(series, STATIC_CAMERA, cfg),
